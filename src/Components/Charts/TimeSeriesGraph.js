...
const TimeSeriesGraph = ({stockData,modelData}) => {
    ...
    var trace1 = {
      ...
      var layout = {
        ...
        xaxis: {
          ...
          rangeslider: {range: ['2010-06-29', '2021-06-24']},
          type: 'date'
        },
        yaxis: {
          autorange: true,
    ...
    else return <Plot data={data} layout={layout} style={{width:'100%',height:'700px'}} useResizeHandler='true' />
}
